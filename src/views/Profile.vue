<script setup>
    ...
    const country = 'COL';
    const language = 'EN';
    const contact = '(123) 555-5555';
    const nick = 'johndoe123';
        ...
        <div class="about">
            <div class="about__about">
                ...
                <div class="about__field">
                    ...
                    <p>VueJS Developer (86 Members)</p>
                </div>
            </div>
            <div class="about__about">
                <div class="about__field">
...
<style scoped>
    ...
    .about__field::before{
        ...
        width: 10%;
        height: 100%;
        background-image: linear-gradient( 90deg, transparent 0%, var(--white) 100%);
    }
